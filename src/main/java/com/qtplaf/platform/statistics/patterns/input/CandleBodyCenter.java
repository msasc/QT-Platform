 ...
 * @author Miquel Sas
 */
public class CandleBodyCenter extends Candle {
	 ...
	 */
	public CandleBodyCenter(int index, PatternInfo patternInfo) {
		super(index, patternInfo);
		setNormalizer(new StdNormalizer(1, 0, 1, -1));
	}
	...
	public double getInput(List<Data> datas) {
		...
		return getNormalizer().normalize(getBodyCenterFactor(data));
	}
