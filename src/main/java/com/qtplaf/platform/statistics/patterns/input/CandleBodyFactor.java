 ...
 * @author Miquel Sas
 */
public class CandleBodyFactor extends Candle {
	 ...
	 */
	public CandleBodyFactor(int index, PatternInfo patternInfo) {
	...
	public double getInput(List<Data> datas) {
		...
		return getNormalizer().normalize(getBodyFactor(data));
	}
